	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">SISTEMA DE GESTIÓN DE ACTIVOS Y SERVICIOS - DRONTEC</a>
				<ul class="user-menu">
					...
					<li class="dropdown pull-right notification">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="reservation">
									<span id="reserveBadge2" class="today_reservation badge"></span> - Reservas de hoy
								</a>
							</li>
						</ul>
					</li>
					...
					<li class="dropdown pull-right notification">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="borrow">
									<span id="dueBorrow" class="badge"></span> - Préstamos por vencer
								</a>
							</li>
						</ul>
					</li>
